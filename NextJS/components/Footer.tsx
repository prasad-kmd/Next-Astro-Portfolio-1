      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li><Link href="/" className="text-sm text-zinc-400 hover:text-accent-cyan transition-colors">Home</Link></li>
            <li><Link href="/about" className="text-sm text-zinc-400 hover:text-accent-cyan transition-colors">About</Link></li>
            <li><Link href="/contact" className="text-sm text-zinc-400 hover:text-accent-cyan transition-colors">Contact</Link></li>
            <li><Link href="/about-site" className="text-sm text-zinc-400 hover:text-accent-cyan transition-colors">About Site</Link></li>
          </ul>
        </div>
